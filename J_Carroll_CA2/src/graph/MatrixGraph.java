...
public class MatrixGraph extends AbstractGraph {
    ...
    public ArrayList<Integer> getVerticesThatVertexIsAdjacentTo(int vertex)
    {
        ArrayList<Integer> adjVertices = new ArrayList<Integer>();
        ArrayList<Integer> noAdjacency = new ArrayList<Integer>();
          for (int i = 0; i < getNumVertices(); i++) {
              if (isEdge(vertex, i)) {
                  adjVertices.add(i);
              }

          System.out.println("Vertex: " + vertex + " Adjacent to " + adjVertices.toString());
      }
