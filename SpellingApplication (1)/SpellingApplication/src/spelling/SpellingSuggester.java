...
public class SpellingSuggester {
    ...
    private List<String> replacements(String word)  {
        // All replacements of a letter in word  - Swap
    ...
    private List<String> deletions(String word) {
        // All deletions of a letter in word - Missing
        ...
        for (int i = 0; i < length; i++) {
                    String s = word.substring(0, i) +  word.substring(i + 1,length);
                    if (dictionary.isWord(s)) {
                        list.add(s);
                        System.out.println(s);
    ...
    private List<String> insertions(String word) {//Append
