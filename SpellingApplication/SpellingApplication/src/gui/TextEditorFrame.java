...
public class TextEditorFrame extends JFrame {
    ...
    //Updatee to lower case words
    private String getWordAtPosition(int position) {
        String s = textArea.getText().substring(0, position).toLowerCase();
        System.out.println("Text to caret position:" + s);
    ...
    private void showSuggestions(MouseEvent e, String word, Dictionary dictionary) {
        ...
        List<String> list = spellingSuggester.getSuggestions(word, NUM_SUGGESTIONS);
